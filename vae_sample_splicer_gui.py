...
class VAESampleSplicerGUI(tk.Tk):
    ...
    def _build_ui(self) -> None:
        ...
        ttk.Button(transport, text="-10", command=lambda: self._step_frame(-10)).pack(side=tk.LEFT, padx=(8, 0))
        ttk.Button(transport, text="-1", command=lambda: self._step_frame(-1)).pack(side=tk.LEFT, padx=(4, 0))
        ttk.Button(transport, text="+1", command=lambda: self._step_frame(1)).pack(side=tk.LEFT, padx=(4, 0))
        ttk.Button(transport, text="+10", command=lambda: self._step_frame(10)).pack(side=tk.LEFT, padx=(4, 0))
